...
class DashboardController extends Controller
{
    function index()
    {
        $unPaid = number_format(Invoice::where('Value_Status', 2)->count() / Invoice::count() * 100, 2);
        $Paid = number_format(Invoice::where('Value_Status', 1)->count() / Invoice::count() * 100, 2);
        $partialPaid = number_format(Invoice::where('Value_Status', 3)->count() / Invoice::count() * 100, 2);
